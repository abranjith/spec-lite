...
If the required plan file is missing, stop and ask the user which plan to review or tell them to run the Planner sub-agent first.
...
```markdown
<!-- Generated by spec-lite v0.0.8 | sub-agent: plan_critic | date: {{date}} -->
...
- **Do NOT** start implementation. This agent critiques the plan only.
