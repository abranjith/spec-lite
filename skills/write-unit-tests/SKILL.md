...
description: >
  Designs and generates comprehensive unit tests that verify individual
  units of behavior in isolation. Supports standalone mode (test a file)
  and feature context mode (test against a feature spec with TASK-ID
  traceability). Includes coverage classification and exclusion config.
metadata:
  author: spec-lite
  version: 0.0.8
---
...
```markdown
<!-- Generated by spec-lite v0.0.8 | skill: write-unit-tests | date: {{date}} -->
